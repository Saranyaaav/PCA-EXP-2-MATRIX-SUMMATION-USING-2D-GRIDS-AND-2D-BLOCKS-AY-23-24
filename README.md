...
## OUTPUT:
<img width="1139" height="275" alt="image" src="https://github.com/user-attachments/assets/3f101442-911e-4f41-b6f3-39f8156e3a89" />


## RESULT:
The host took 0.88581 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.059956 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
